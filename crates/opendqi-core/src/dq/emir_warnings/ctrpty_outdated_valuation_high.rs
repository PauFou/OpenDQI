//! EMIR.WRN.CTRPTY_OUTDATED_VALUATION_HIGH — per-counterparty share of
//! outstanding derivatives whose valuation is outdated exceeds the
...
pub struct EmirWrnCtrptyOutdatedValuationHigh;

const CHECK_ID: &str = "EMIR.WRN.CTRPTY_OUTDATED_VALUATION_HIGH";

impl WarningsCounterpartyCheck for EmirWrnCtrptyOutdatedValuationHigh {
...
mod tests {
    ...
    fn flags_only_above_threshold() {
        ...
        let issues = EmirWrnCtrptyOutdatedValuationHigh.run(&recs, &ctx);
